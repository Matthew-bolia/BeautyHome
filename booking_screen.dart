      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
            CircleAvatar(
              radius: 28,
              backgroundImage: CachedNetworkImageProvider(sp.imageUrl),
            ),
...
// Ajoutez d'autres widgets communs ici, comme PrimaryButton, StylistCard, etc.
...
class ServiceStepSkeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        // Exemple de skeleton : des rectangles animés pour simuler le chargement
        Container(
          height: 50,
        ...
        // Ajoutez plus de rectangles selon vos besoins
      ],
    );
  }
}
